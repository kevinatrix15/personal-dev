...
{
  // ***Loop over all inner nodes of a representative cell***
  // ***Calculate fractional position in each dimension***
  ...
  for (size_t z = 0; z < zPtsPerCell; ++z) {
    ...
    for (size_t y = 0; y < yPtsPerCell; ++y) {
      ...
      for (size_t x = 0; x < xPtsPerCell; ++x) {
        ...
        // ***Calculate ratio of point to the outer cell nodes***
        ...
        // ***Calculate weights using ratios***
        ...
        // ***Store weights in global collection***
